...
export default function Hero() {
  return (
    <section className="w-full bg-[url(/grid.svg)] bg-center bg-cover bg-no-repeat ">
      {/* Rating */}
      <div className="text-center py-16  relative overflow-hidden px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-primary rounded-2xl max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 px-6 sm:px-8 overflow-hidden">
          {/* Custom Gradient Background - Radiant Effect */}

          {/* Left Section */}
          <div className="relative z-10 text-white w-full lg:w-1/2 text-start">
          ...
          {/* Right Section */}
          <div className="relative z-10 w-full lg:w-1/2 flex justify-center mt-8 lg:mt-0">
            <Image
